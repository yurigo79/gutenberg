...
const meta: Meta< typeof Popover > = {
	...
	component: Popover,
	argTypes: {
		anchor: { control: { type: false } },
		anchorRef: { control: { type: false } },
		anchorRect: { control: { type: false } },
		children: { control: { type: false } },
		focusOnMount: {
			control: { type: 'select' },
			options: [ 'firstElement', true, false ],
		},
		getAnchorRect: { control: { type: false } },
		onClose: { action: 'onClose' },
		onFocusOutside: { action: 'onFocusOutside' },
		__unstableSlotName: { control: { type: false } },
	},
	parameters: {
